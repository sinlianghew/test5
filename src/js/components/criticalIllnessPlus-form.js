...
const m3paform = new Vue({
    ...
    data: {
        ...
        prescreenYesNo5:false,
        prescreenYesNo6:false,
        bmiHeight:'',
        bmiWeight:'',
        bmi:'',
    ...
    methods: {
		...
		console.log("test edit");
            if(name == 2){
                ...
                this.prescreenYesNo3 = value;
            }
            else if(name == 4){
                this.prescreenYesNo4 = value;
            }
            else if(name == 5){
                this.prescreenYesNo5 = value;
                this.prescreenYesNo6 = false; 
            }
            else if(name == 6){
                this.prescreenYesNo6 = value;
            }
        },
        /* jw - mini PA */
        openDate:function (){
    ...
    computed: {
        bmiComputed:function(){
            ...
            var bmiCalculated = parseFloat(numweight)/((parseFloat(numheight)/100)*(parseFloat(numheight)/100));
            if(isNaN(bmiCalculated)){
                return '-';
            }else{
                return bmiCalculated.toFixed(2);
            }
        },
