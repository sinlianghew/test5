...
const m3paform = new Vue({
    ...
    updated() {
        ...
        if (motorModelInput.length > 0) {
            ...
            //console.log("updated() inside if motorModelInput.length>0 - this.originalModelIsInvalid: " + this.originalModelIsInvalid);
            //console.log(this.originalModelIsInvalid === true);
        ...
        //console.log("updated() - this.originalModelIsInvalid: " + this.originalModelIsInvalid);
        //console.log(this.originalModelIsInvalid === true);
        if (this.originalModelIsInvalid === true) {
    ...
    methods: {
        ...
        onSubmit: async function () {
            ...
            if (this.currStep.stepNum == '1') {
                ...
                //this.formData['5'].ccNo
                //$('input[name=ccNo]').val();
                var cardNoTrimmed = $('input[name=ccNo]').val().split(" ").join("");
                $('input[name=ccNo]').val(cardNoTrimmed);
